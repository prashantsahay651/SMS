...
<div class="row">
    ...
    <div class="col-md-8">
        <input type="text" name="teacherName" value="${teacher.getTeacherName()}" disabled="disabled">
    </div>
    </div>
    <div class="col-md-6">
    <div class="col-md-4">
    ...
    <div class="col-md-8">
        <input type="text" name="emailId" value="${teacher.getEmailId()}" disabled="disabled">
    </div>
    </div>
    <div class="col-md-6">
    <div class="col-md-4">
    ...
    <div class="col-md-8">
        <input type="text" name="mobileNumber" value="${teacher.getMobileNumber()}" disabled="disabled">
    </div>
    </div>
    <div class="col-md-6">
    <div class="col-md-4">
    ...
    <div class="col-md-8">
        <input type="text" name="alternateMobileNumber" value="${teacher.getAlternateMobileNumber()}" disabled="disabled">
    </div>
    </div>
    ...
    <div class="col-md-8">
        <textarea name="addressLine1" disabled="disabled">${teacher.getAddressLine1()}</textarea>
    </div>
    </div>
    <div class="col-md-6">
    <div class="col-md-4">
    ...
    <div class="col-md-8">
        <textarea name="addressLine2" disabled="disabled">${teacher.getAddressLine2()}</textarea>
    </div>
        </div>
    ...
    <div class="col-md-8">
        <input type="text" name="city" value="${teacher.getCity()}" disabled="disabled">
    </div>
    </div>
    <div class="col-md-6">
    <div class="col-md-4">
    ...
    <div class="col-md-8">
        <input type="text" name="district" value="${teacher.getDistrict()}" disabled="disabled">
    </div>
    </div>
    <div class="col-md-6">
    <div class="col-md-4">
    ...
    <div class="col-md-8">
        <input type="text" name="state" value="${teacher.getState()}" disabled="disabled">
    </div>
    </div>
    <div class="col-md-6">
    <div class="col-md-4">
    ...
    <div class="col-md-8">
        <input type="text" name="pinCode" value="${teacher.getPinCode()}" disabled="disabled">
    </div>
    </div> 
