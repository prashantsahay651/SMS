...
<div class="container-fluid signupmain">
	...
	<div class="row">
	<form name="myform" method="post" action="WebAddSubjectToSection" onsubmit="return validateform()" enctype="multipart/form-data">  
	...
	<div class="col-md-12">
		...
		<select class="company1" name="teacherId">
			<option selected disabled="disabled">Select Class...</option>
